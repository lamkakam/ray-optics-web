...
export default function Home() {
  ...
  const headerSelect = clsx(cx.select.style.compact, cx.select.color.borderColor, cx.select.color.bgColor, cx.select.color.textColor, cx.select.size.compactPadding, cx.select.size.compactFontSize);
