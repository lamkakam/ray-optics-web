...
- Uses `Back to lens editor` without changing the plotted selection and verifies the modal restores the draft while the prescription row remains unchanged.
