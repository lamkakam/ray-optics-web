...
5. Verify every imported surface row shows the expected label, radius, thickness, medium, and semi-diameter, and that no aspherical or tilt/decenter state is active.
