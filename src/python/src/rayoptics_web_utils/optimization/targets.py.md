...
```python
snapshot_state(opm: OpticalModel, variable_configs: list[VariableConfig], pickup_configs: list[PickupConfig]) -> dict[TargetKey, float]
restore_state(opm: OpticalModel, snapshot: dict[TargetKey, float]) -> None
