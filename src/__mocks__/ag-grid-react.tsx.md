...
- Exposes theme, layout, default column, column width, `stopEditingWhenCellsLoseFocus`, and edit lifecycle callback presence as `data-*` attributes for component tests.
