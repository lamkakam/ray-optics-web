...
const VARIANT_CLASSES: Record<ParagraphVariant, readonly string[]> = {
  ...
  subheading: [
    cx.text.style.subheadingFontWeight,
    cx.text.color.subheadingTextColor,
    cx.text.size.subheadingFontSize,
  ],
  placeholder: [
    cx.text.color.placeholderTextColor,
    cx.text.size.placeholderFontSize,
  ],
