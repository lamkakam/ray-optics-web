...
- Bounds the legend to the plot width and adds `24px` of top spacing per wrapped legend row so multi-wavelength legends do not overlap subplot titles or grids on narrow charts.
