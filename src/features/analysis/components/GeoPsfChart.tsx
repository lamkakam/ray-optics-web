...
export function GeoPsfChart({
  ...
  const chartOption = useMemo(
    () => chartDimensions === undefined
      ? undefined
      : buildGeoPsfOption(geoPsfData, chartDimensions.width, chartDimensions.height, chartTextColor),
    [chartDimensions, chartTextColor, geoPsfData],
  );
