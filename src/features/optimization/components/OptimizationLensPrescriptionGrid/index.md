...
- [OptimizationLensPrescriptionGrid.tsx](./OptimizationLensPrescriptionGrid/OptimizationLensPrescriptionGrid.tsx) — read-only prescription grid with modal-backed inspection cells
...
- [ModeSelectField.tsx](./ModeSelectField/ModeSelectField.tsx) — shared constant/variable/pickup mode selector for optimization modals
...
- [PickupModeFields.tsx](./PickupModeFields/PickupModeFields.tsx) — shared pickup field group for optimization modal editors
