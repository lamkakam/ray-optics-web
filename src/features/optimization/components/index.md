...
- [BottomDrawerContainer.tsx](./BottomDrawerContainer/BottomDrawerContainer.tsx) — responsive optimization bottom drawer and five-tab assembly
- [BottomDrawerContainer/index.ts](./BottomDrawerContainer/index.ts.md) — public directory import for the bottom drawer container
- [OptimizationActionBar.tsx](./OptimizationActionBar/OptimizationActionBar.tsx) — primary page actions for optimization and apply-to-editor
- [OptimizationActionBar/index.ts](./OptimizationActionBar/index.ts.md) — public directory import for the action bar
- [OptimizationEvaluationPanel.tsx](./OptimizationEvaluationPanel/OptimizationEvaluationPanel.tsx) — static residual table and empty/loading states
...
- [OptimizationAlgorithmTab.tsx](./OptimizationAlgorithmTab/OptimizationAlgorithmTab.tsx) — optimizer parameter form
...
- [BoundedVariableModeFields.tsx](../lib/BoundedVariableModeFields/BoundedVariableModeFields.tsx) — shared Min/Max field group for optimization variable editors
- [UnboundedVariableModeFields.tsx](../lib/UnboundedVariableModeFields/UnboundedVariableModeFields.tsx) — unbounded variable-mode body for methods without bounds
...
- [OptimizationWeightsGrid.tsx](./OptimizationWeightsGrid/OptimizationWeightsGrid.tsx) — shared AG Grid view for field and wavelength weights
...
- [OptimizationOperandsTab.tsx](./OptimizationOperandsTab/OptimizationOperandsTab.tsx) — editable operand grid and add/delete actions
- [OptimizationOperandsTab/index.ts](./OptimizationOperandsTab/index.ts.md) — public directory import for the operands tab
- [OptimizationApplyConfirmModal.tsx](./OptimizationApplyConfirmModal/OptimizationApplyConfirmModal.tsx) — apply confirmation dialog wrapper
...
- [OptimizationProgressModal.tsx](./OptimizationProgressModal/OptimizationProgressModal.tsx) — blocking optimization-progress dialog with live merit chart
...
- [RadiusModeModal.tsx](./RadiusModeModal/RadiusModeModal.tsx) — radius variable/pickup modal body
- [RadiusModeModal/index.ts](./RadiusModeModal/index.ts.md) — public directory import for the radius modal
- [ThicknessModeModal.tsx](./ThicknessModeModal/ThicknessModeModal.tsx) — thickness variable/pickup modal body
- [ThicknessModeModal/index.ts](./ThicknessModeModal/index.ts.md) — public directory import for the thickness modal
- [AsphereVarModal.tsx](./AsphereVarModal/AsphereVarModal.tsx) — asphere variable/pickup modal body
