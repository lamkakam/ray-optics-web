...
- [VariableModeFields.tsx](./VariableModeFields.tsx.md) — shared Min/Max field group for optimization variable editors
...
- [RadiusModeModal.tsx](./RadiusModeModal.tsx.md) — radius variable/pickup modal body
