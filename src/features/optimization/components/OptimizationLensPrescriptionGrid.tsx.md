...
Renders the optimization lens prescription grid, including a read-only surface `Index` column, radius/thickness variable buttons, and read-only inspection cells that open existing lens-editor dialogs.
