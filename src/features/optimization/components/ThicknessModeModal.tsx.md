...
- Delegates the shared mode selector plus variable/pickup form sections to `ModeSelectField.tsx`, `BoundedVariableModeFields.tsx`, and `PickupModeFields.tsx`, while keeping thickness-specific draft transitions and summary text in this modal.
