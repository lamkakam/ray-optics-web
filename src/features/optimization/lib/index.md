...
- [BoundedVariableModeFields.tsx](./BoundedVariableModeFields/BoundedVariableModeFields.tsx) — shared Min/Max field group for optimization variable editors
- [UnboundedVariableModeFields.tsx](./UnboundedVariableModeFields/UnboundedVariableModeFields.tsx) — unbounded variable-mode body for methods without bounds
- [applyOptimizationModelToEditor.ts](./applyOptimizationModelToEditor.ts) — shared helper that applies an Optimization-local optical model snapshot back to the editor stores
...
- [optimizationViewModels.ts](./optimizationViewModels.ts) — shared row/view helpers for optimization components
