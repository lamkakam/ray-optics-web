...
import { MediumSelectorModal } from "../";
import {
  GlassCatalogContext,
...
describe("MediumSelectorModal", () => {
    ...
    catalogs: {
      ...
      Ohara: {
        "S-FPL51": {
          ...
          abbeNumberD: 81.6,
          abbeNumberE: 81.3,
          partialDispersions: { P_Fd: 0.4, P_fe: 0.39, P_gF: 0.53 },
      ...
      Schott: {
        "N-BK7": {
          ...
          abbeNumberD: 64.17,
          abbeNumberE: 63.96,
          partialDispersions: { P_Fd: 0.41, P_fe: 0.4, P_gF: 0.5349 },
          dispersionCoeffKind: "Sellmeier3T",
          dispersionCoeffs: [1, 2, 3, 4, 5, 6],
        },
        "N-SF6": {
          ...
          abbeNumberD: 25.36,
          abbeNumberE: 25.2,
          partialDispersions: { P_Fd: 0.305, P_fe: 0.298, P_gF: 0.6439 },
          dispersionCoeffKind: "Sellmeier3T",
          dispersionCoeffs: [1, 2, 3, 4, 5, 6],
        },
      },
      ...
      Special: {
        CaF2: {
          ...
          abbeNumberD: 95.1,
          abbeNumberE: 94.3,
          partialDispersions: { P_Fd: 0.702, P_fe: 0.456, P_gF: 0.552 },
          dispersionCoeffKind: "Sellmeier3T",
          dispersionCoeffs: [1, 2, 3, 4, 5, 6],
        },
        D263TECO: {
  ...
  it("has a Catalog dropdown with Special and provider catalogs", () => {
    renderWithCatalogs(<MediumSelectorModal {...defaultProps} />);
    const select = screen.getByLabelText("Catalog");
  ...
  it("clears Glass and invalidates selection when changing between catalogs", async () => {
    ...
    await userEvent.selectOptions(screen.getByLabelText("Catalog"), "Ohara");
