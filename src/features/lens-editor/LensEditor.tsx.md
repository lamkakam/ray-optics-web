...
- When the selected plot type is `rayFan`, `spotDiagram`, `wavefrontMap`, `geoPSF`, or `diffractionPSF`, submit/example-confirm flows store typed chart data via the matching analysis-plot store setter instead of requesting PNG plots
