...
- **Plot return type**: Plot image functions return a `string` (base64-encoded image), while `getWavefrontData` and `getDiffractionPSFData` return typed axis/grid data for frontend rendering.
