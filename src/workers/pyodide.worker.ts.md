...
- **Plot return type**: Plot image functions return a `string` (base64-encoded image), while `getDiffractionPSFData` returns typed axis/grid data for frontend rendering.
