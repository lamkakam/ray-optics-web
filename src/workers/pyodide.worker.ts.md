...
- **Plot return type**: Plot image functions return a `string` (base64-encoded image), while `getWavefrontData`, `getGeoPSFData`, and `getDiffractionPSFData` return typed data for frontend rendering.
