...
jest.mock("@/components/container/SpecsConfigurerContainer", () => ({
  SpecsConfigurerContainer: () => <div data-testid="specs-content">Specs Content</div>,
}));

jest.mock("@/components/container/LensPrescriptionContainer", () => ({
  LensPrescriptionContainer: () => <div data-testid="prescription-content">Prescription Content</div>,
}));

jest.mock("@/components/container/FocusingContainer", () => ({
